...
export default function Navbar() {
  ...
  return (
    <>
      {/* Sidebar (Desktop) */}
      <nav className="hidden sm:flex flex-col w-64 bg-[#f54257] text-white min-h-screen p-4">
      ...
      <nav className="flex sm:hidden fixed top-0 left-0 w-full bg-[#f54257] text-white py-3 px-4 shadow-md">
      ...
      {menuOpen && (
        <div className="sm:hidden fixed top-12 left-0 w-full bg-[#f54257] text-white p-4 shadow-md">
